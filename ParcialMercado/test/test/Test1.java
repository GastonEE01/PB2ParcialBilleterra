...
public class Test1 {
	...
	public void queSePuedaCrearUnConsumidor() {
		...
		assertEquals(DNI_ESPERADO, nuevo.getCuit());
	}
	...
	public void queSePuedanAgregarDistintosMediosDePagoALaBilleteraDeUnConsumidor() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, NoCoincideTitularException{
		// Preparaci�n  ,modifique la cantidad a de 4 a 5 
		...
		// Verificaci�n
		assertEquals(CANTIDAD_DE_MEDIOS_EN_LA_BILLETERA_ESPERADOS, mataGalan.getCantidadDeMediosDePago());
	}
	
	
	@Test
	public void queSePuedaPagarConUnaTarjetaDeCredito() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, ExcedeLimiteDeCompraException, NoCoincideTitularException{//NoCoincideTitularException
		// Preparaci�n 
		Billetera mataGalan = new Billetera("Ank");
	    Consumidor luisGomez = new Consumidor(27541231, "Luis Gomez"); // Crear el consumidor
		mataGalan.agregarConsumidor(luisGomez);
		...
		//Boolean resultado = mataGalan.pagar(codigoQR, ((Billetera) mataGalan.getConsumidor(27541231)).getMedioPagador(48332562153254623L));
	    Boolean resultado = mataGalan.pagar(codigoQR,luisGomez.getCuit() ); // Obtener el DNI de Luis Gomez
	...
	//Aplicar las exepciones
	@Test
	public void queSePuedaTransferirDeUnaCuentaAOtra() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, SaldoInsuficienteException, NoCoincideTitularException{//NoCoincideTitularException
		// Preparaci�n 
	...
	public void queNoSePuedaTransferirSiElSaldoNoEsSuficiente() throws NoCoincideTitularException, CBUInvalidoException, SaldoInsuficienteException {
		Billetera mataGalan = new Billetera("Ual�");
		Transferible cuentaOrigen = new CuentaBancaria("01702046600000087865", "Naci�n", "Luis Gomez");
		Consumidor consumidorOrigen = new Consumidor(27541231, "Luis Gomez");
		mataGalan.agregarConsumidor(consumidorOrigen);
		...
		mataGalan.agregarConsumidor(consumidorDestino);
		mataGalan.agregarMedioDePago(33896541, cuentaDestino);
		cuentaOrigen.depositarSaldo(1000.0);
		cuentaDestino.depositarSaldo(2000.0);
		// Ejecuci�n
		Boolean resultado = mataGalan.transferir(cuentaOrigen, cuentaDestino);
